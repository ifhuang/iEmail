 ...
 * @author	If
 */
public class FolderModelC3 extends AbstractTableModel {
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        if (aValue.toString().equals("true")) {
            Client.spamtest.add(folder[rowIndex].getAbsolutePath());
        } else {
            Client.spamtest.remove(folder[rowIndex].getAbsolutePath());
        }
    }
}

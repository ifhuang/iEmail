...
import edu.ecnu.sei.hif.model.FolderModelN2;
import java.awt.*;
import java.io.File;
import javax.swing.*;
 ...
 * @author	If
 */
public class FolderViewerN2 extends JPanel {

    FolderModelN2 model;
    JScrollPane scrollpane;
    JTable table;

    public FolderViewerN2() {
        this(null);
    }

    public FolderViewerN2(File what) {
        super(new GridLayout(1, 1));
        model = new FolderModelN2();

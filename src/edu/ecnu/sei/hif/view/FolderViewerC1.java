...
import edu.ecnu.sei.hif.model.FolderModelC1;
import java.awt.*;
import java.io.File;
import javax.swing.*;
 ...
 * @author	If
 */
public class FolderViewerC1 extends JPanel {
    
    FolderModelC1 model;
    JScrollPane scrollpane;
    JTable table;
    
    public FolderViewerC1() {
        this(null);
    }
    
    public FolderViewerC1(File[] what) {
        super(new GridLayout(1, 1));
        model = new FolderModelC1();

...
import edu.ecnu.sei.hif.model.FolderModelC3;
import java.awt.*;
import java.io.File;
import javax.swing.*;
 ...
 * @author	If
 */
public class FolderViewerC3 extends JPanel {

    FolderModelC3 model;
    JScrollPane scrollpane;
    JTable table;

    public FolderViewerC3() {
        this(null);
    }

    public FolderViewerC3(File[] what) {
        super(new GridLayout(1, 1));
        model = new FolderModelC3();

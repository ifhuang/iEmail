...
import edu.ecnu.sei.hif.model.FolderModelC2;
import java.awt.*;
import java.io.File;
import javax.swing.*;
 ...
 * @author	If
 */
public class FolderViewerC2 extends JPanel {

    FolderModelC2 model;
    JScrollPane scrollpane;
    JTable table;

    public FolderViewerC2() {
        this(null);
    }

    public FolderViewerC2(File[] what) {
        super(new GridLayout(1, 1));
        model = new FolderModelC2();

...
import edu.ecnu.sei.hif.model.FolderModelN3;
import java.awt.*;
import java.io.File;
import javax.swing.*;
 ...
 * @author	If
 */
public class FolderViewerN3 extends JPanel {

    FolderModelN3 model;
    JScrollPane scrollpane;
    JTable table;

    public FolderViewerN3() {
        this(null);
    }

    public FolderViewerN3(File what) {
        super(new GridLayout(1, 1));
        model = new FolderModelN3();

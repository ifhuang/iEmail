...
import edu.ecnu.sei.hif.model.FolderModelC4;
import java.awt.*;
import java.io.File;
import javax.swing.*;
 ...
 * @author	If
 */
public class FolderViewerC4 extends JPanel {
    
    FolderModelC4 model;
    JScrollPane scrollpane;
    JTable table;
    
    public FolderViewerC4() {
        this(null);
    }
    
    public FolderViewerC4(File[] what) {
        super(new GridLayout(1, 1));
        model = new FolderModelC4();
